...
def argumentParser():
    ...
    parser.add_argument('--google-sheet',
                        metavar=('<TOKEN_PATH>', '<CREDENTIALS_PATH>', '<SHEET_ID>',
                                 '<TAB_NAME>'),
                        nargs=4,
...
def logOnGoogleSpreadsheet():
    ...
    #TOKEN_PATH = os.path.join("google_sheets_token.json")
    #CREDENTIALS_PATH = os.path.join("google_sheets_credentials.json")
